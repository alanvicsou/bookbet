...
class Plan(Base):
    ...
    has_live = models.BooleanField(default=False, verbose_name='Possui Live?',
                                   help_text='Marque esta opção caso o plano em questão possua o tipo Live de apostas')
    live_only = models.BooleanField(default=False, verbose_name='Apenas Live?',
                                    help_text='Marque esta opção caso o plano em questão deva contemplar apenas as apostas do tipo Live')
...
class User(UUIDModel, AbstractUser):
    ...
    checkout = models.CharField(max_length=150, null=True)
    produto_link = models.CharField(max_length=200, null=True)
    produto2_link = models.CharField(max_length=300, null=True)
    produto3_link = models.CharField(max_length=300, null=True)
    telsuporte = models.CharField(max_length=30, null=True)
...
class Payment(Base):
    ...
    status = models.CharField(max_length=100, choices=PaymentStatus.choices, default=PaymentStatus.PENDING,
                              verbose_name='Status')
...
class Commission(Base):
    ...
    status = models.CharField(editable=False, max_length=100, choices=CommissionStatus.choices,
                              default=CommissionStatus.WAITING, verbose_name='Status')
